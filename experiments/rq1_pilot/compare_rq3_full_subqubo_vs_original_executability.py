"""
Compare full RQ3 sub-QUBO executability against original-QUBO executability.
...
Purpose:
    Quantify how much each extracted sub-QUBO reduces QAOA circuit/transpilation
...
def main() -> None:
    ...
    # Keep only the sparse topologies used in RQ3 full.
    orig_df = orig_df[
    ...
    # Absolute reductions. Positive means sub-QUBO is cheaper.
    ...
    print("=" * 80)
    print("RQ3 full sub-QUBO vs original executability comparison saved")
    print("=" * 80)
