"""
Create final RQ3 full trade-off table.
...
This table combines:
    ...
    3. lifted solution-quality preservation gap
"""
...
def main() -> None:
    ...
    # Executability is sub-QUBO x topology.
    # First summarize it to sub-QUBO level.
    exec_summary = (
        exec_df.groupby(
            [
    ...
    # Final manuscript-oriented summary:
    # family x k x extraction strategy.
    final = (
        merged.groupby(
            [
                "original_family",
        ...
        .agg(
            ...
            mean_original_transpiled_depth=("mean_original_transpiled_depth", "mean"),
            mean_original_transpiled_2q=("mean_original_transpiled_2q", "mean"),
            mean_original_swap_count=("mean_original_swap_count", "mean"),
    ...
    # Efficiency / trade-off proxy metrics.
    final["weighted_preservation_per_depth"] = (
        final["mean_weighted_edge_preservation"] / final["mean_sub_transpiled_depth"]
    )

    final["weighted_preservation_per_2q"] = (
        final["mean_weighted_edge_preservation"] / final["mean_sub_transpiled_2q"]
    )
    ...
    print("=" * 80)
    print("RQ3 full final trade-off table saved")
    print("=" * 80)
    ...
    print()
    print("By k and strategy:")
    by_k = (
        final.groupby(["k_variables", "extraction_strategy"], as_index=False)
        .agg(
            n_rows=("n_subqubos", "sum"),
            mean_weighted_edge_preservation=("mean_weighted_edge_preservation", "mean"),
            mean_pct_depth_reduction=("mean_pct_depth_reduction_vs_original", "mean"),
