"""
RQ3 full sub-QUBO executability experiment.

This script evaluates QAOA/transpilation executability metrics for all
RQ3 full extracted sub-QUBOs.
...
def main() -> None:
    ...
    print("=" * 80)
    print("RQ3 full sub-QUBO executability metrics saved")
    print("=" * 80)
